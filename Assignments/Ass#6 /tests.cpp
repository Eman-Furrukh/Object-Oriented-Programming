#include "pch.h"
#include "../21i-1726_B/Invoice.h"
#include "../21i-1726_B/Date.h"
#include "../21i-1726_B/DateAndTime.h"
#include "../21i-1726_B/Integer.h"
#include "../21i-1726_B/Family.h"
#include "../21i-1726_B/Matrix.h"
#include "../21i-1726_B/SavingAccount.h"

//------------------------------------- Question #01 ------------------------------

TEST(Q1, first) {
	Invoice i1(0, 0, -3, -2.0);
